...
* ### [Data]([https://www.kaggle.com/datasets/cdminix/us-drought-meteorological-data](https://www.kaggle.com/datasets/mdsharibzeya/patient-survival-prediction-model?select=Data+Dictionary.csv)) 
